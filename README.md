...
Click here to Chat with Gem, the Zoo Guide
...
Frontend Agent (CPU): A lightweight Python service using the Google Agent Development Kit (ADK). It handles user sessions, routing, and the chat interface.

AI Backend (GPU): A dedicated service running Ollama with the Gemma 3 (270m) model on an NVIDIA L4 GPU.
